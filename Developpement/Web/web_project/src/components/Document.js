...
const Document = ({ document, onRemoveDocument, onDisplayDocument, isEdition, show }) => {
                                    ...
                                    isErrorS ?
                                        ...
                                        <>
                                            ...
                                            <Tooltip title="Étape" arrow>
                                                <Stack direction="row" alignItems="center" spacing={1} width="5%" marginRight={150}>
                                                    <img src={StepIcon} />
                                                    <Typography variant="h8" style={{ fontWeight: "normal" }}>
                                                        {step.title}
                                                    </Typography>
